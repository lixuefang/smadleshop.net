    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table">
                ...
                <el-table-column prop="orderType" label="积分">
                </el-table-column>
                <el-table-column prop="orderState" label="状态">
                </el-table-column>
                <el-table-column prop="contactPerson" label="收货人">
                </el-table-column>
                <el-table-column prop="expressNum" label="快递单号">
                </el-table-column>
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-delete" class="red" @click="handleDelete(scope.$index, scope.row)">查看</el-button>
                    </template>
                </el-table-column>
            </el-table>
