    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i>推广软文管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 保存新增
            saveAdd() {
                this.$axios.post("/SiteArticle/Add", this.form).then((res) => {
                    if (res.data.code == 1) {
            ...
            // 保存编辑
            saveEdit() {
                this.$axios.post("/SiteArticle/Edit", this.form).then((res) => {
                    if (res.data.code == 1) {
            ...
            // 确定删除
            deleteRow() {
                this.$axios.post("/SiteArticle/Del", this.form).then((res) => {
                    if (res.data.code == 1) {
