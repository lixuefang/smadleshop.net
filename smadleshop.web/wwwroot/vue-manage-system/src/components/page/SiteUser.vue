...
<script>
    export default {
        ...
        methods: {
            ...
            // 保存新增
            saveAdd() {
                this.$axios.post("/siteuser/add", this.form).then((res) => {
                    if (res.data.code == 1) {
            ...
            // 保存编辑
            saveEdit() {
                this.$axios.post("/siteuser/edit", this.form).then((res) => {
                    if (res.data.code == 1) {
            ...
            // 确定删除
            deleteRow() {
                this.$axios.post("/siteuser/Del", this.form).then((res) => {
                    if (res.data.code == 1) {
